...
public class TokenTest extends BlockchainTest {
    ...
    public void testParseValidToken() throws Exception {
        ...
        Token actual = Token.parseToken(token, "http://egl.org");
    ...
    public void testGenerateToken() throws Exception {
        ...
        String tokenString = Token.generateToken("secret", "http://egl.org");
        int end = Eagle.getEpochTime();
        Token token = Token.parseToken(tokenString, "http://egl.org");
    ...
    public void emptySecret() throws Exception {
        String tokenString = Token.generateToken("", "http://egl.org");
        Token token = Token.parseToken(tokenString, "http://egl.org");
        assertTrue(token.isValid());
    }
