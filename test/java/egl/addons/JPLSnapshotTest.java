...
public class JPLSnapshotTest extends BlockchainTest {
    ...
    public void testSnapshotWithoutInput() {
        ...
        Assert.assertTrue(total > Constants.MAX_BALANCE_NQT - 100000 * Constants.ONE_EGL); // some funds were sent to genesis or are locked in claimable currency
    }
    ...
    public void testSnapshotWithInput() {
        ...
        Assert.assertTrue(BigInteger.valueOf(aliceCurrentBalance).divide(BigInteger.valueOf(10)).subtract(BigInteger.valueOf(aliceSnapshotBalance)).longValueExact() < Constants.ONE_EGL);
