...
import egl.ShufflingTransaction;
import egl.Tester;
import egl.Transaction;
import egl.crypto.AnonymouslyEncryptedData;
...
import static egl.http.shuffling.ShufflingUtil.ALICE_RECIPIENT;
import static egl.http.shuffling.ShufflingUtil.BOB_RECIPIENT;
import static egl.http.shuffling.ShufflingUtil.CHUCK_RECIPIENT;
import static egl.http.shuffling.ShufflingUtil.DAVE_RECIPIENT;
import static egl.http.shuffling.ShufflingUtil.broadcast;
import static egl.http.shuffling.ShufflingUtil.cancel;
import static egl.http.shuffling.ShufflingUtil.create;
import static egl.http.shuffling.ShufflingUtil.createAssetShuffling;
import static egl.http.shuffling.ShufflingUtil.createCurrencyShuffling;
import static egl.http.shuffling.ShufflingUtil.defaultHoldingShufflingAmount;
import static egl.http.shuffling.ShufflingUtil.defaultShufflingAmount;
import static egl.http.shuffling.ShufflingUtil.getShuffling;
import static egl.http.shuffling.ShufflingUtil.getShufflingParticipants;
import static egl.http.shuffling.ShufflingUtil.process;
import static egl.http.shuffling.ShufflingUtil.register;
import static egl.http.shuffling.ShufflingUtil.shufflingAsset;
import static egl.http.shuffling.ShufflingUtil.shufflingCurrency;
import static egl.http.shuffling.ShufflingUtil.startShuffler;
import static egl.http.shuffling.ShufflingUtil.stopShuffler;
import static egl.http.shuffling.ShufflingUtil.verify;
...
public class TestAutomatedShuffling extends BlockchainTest {
    ...
    public void successfulShuffling() {
        ...
        Assert.assertEquals(-(defaultShufflingAmount + 11 * Constants.ONE_EGL), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + Constants.ONE_EGL), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, CHUCK.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + Constants.ONE_EGL), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + Constants.ONE_EGL), DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), ALICE.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), BOB.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), DAVE.getBalanceDiff());
        Assert.assertEquals(-(defaultShufflingAmount + 12 * Constants.ONE_EGL), DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(48 * Constants.ONE_EGL, FORGY.getBalanceDiff());
        Assert.assertEquals(48 * Constants.ONE_EGL, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void successfulAssetShuffling() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), BOB.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), DAVE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL), DAVE.getUnconfirmedBalanceDiff());
    ...
    public void processingNotStarted() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_EGL), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_EGL), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, CHUCK.getBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(4 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(4 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void tooManyParticipants() {
        ...
        Assert.assertEquals(3 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(3 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void processingNotFinished() {
        ...
        Assert.assertEquals(-11 * Constants.ONE_EGL, ALICE.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, CHUCK.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_EGL), DAVE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_EGL), DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(34 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(34 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void verifyNotFinished() {
        ...
        Assert.assertEquals(-12 * Constants.ONE_EGL, ALICE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_EGL), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_EGL), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(47 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(47 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void cancelAfterVerifyChuck() {
        ...
        Assert.assertEquals(-22 * Constants.ONE_EGL, ALICE.getBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_EGL, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_EGL), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_EGL), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(77 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(77 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void cancelAfterVerifyChuckInvalidKeysAlice() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 22 * Constants.ONE_EGL), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 22 * Constants.ONE_EGL), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-22 * Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_EGL, CHUCK.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_EGL, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
    ...
    public void badProcessDataAlice() {
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_EGL), ALICE.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 11 * Constants.ONE_EGL), ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, CHUCK.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(24 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(24 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void modifiedProcessDataBob() {
        ...
        Assert.assertEquals(-21 * Constants.ONE_EGL, ALICE.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_EGL, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (bobCancelFailed ? 11 : 21) * Constants.ONE_EGL), BOB.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (bobCancelFailed ? 11 : 21) * Constants.ONE_EGL), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, CHUCK.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals((bobCancelFailed ? 44 : 54) * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals((bobCancelFailed ? 44 : 54) * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void duplicateProcessDataBob() {
        ...
        Assert.assertEquals(-21 * Constants.ONE_EGL, ALICE.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_EGL, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_EGL), BOB.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 21 * Constants.ONE_EGL), BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, CHUCK.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals(54 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(54 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void modifiedProcessDataChuck() {
        ...
        Assert.assertEquals(-21 * Constants.ONE_EGL, ALICE.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_EGL, ALICE.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-21 * Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (chuckCancelFailed ? 11 : 21) * Constants.ONE_EGL), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + (chuckCancelFailed ? 11 : 21) * Constants.ONE_EGL), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-12 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
        ...
        Assert.assertEquals((chuckCancelFailed ? 65 : 75) * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals((chuckCancelFailed ? 65 : 75) * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void modifiedRecipientKeysDave() {
        ...
        Assert.assertEquals(-65 * Constants.ONE_EGL, ALICE.getBalanceDiff() + BOB.getBalanceDiff() + CHUCK.getBalanceDiff());
    ...
    public void duplicateProcessDataChuck() {
        ...
        Assert.assertEquals(-11 * Constants.ONE_EGL, BOB.getBalanceDiff());
        Assert.assertEquals(-11 * Constants.ONE_EGL, BOB.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_EGL), CHUCK.getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + Constants.ONE_EGL), CHUCK.getUnconfirmedBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getBalanceDiff());
        Assert.assertEquals(-1 * Constants.ONE_EGL, DAVE.getUnconfirmedBalanceDiff());
    ...
    public void maxShufflingSize() {
        ...
        for (int i = 0; i < n + 5; i++) {
            generateBlock();
            Block block = Eagle.getBlockchain().getLastBlock();
        ...
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL) + 100 * Constants.ONE_EGL, participants[n - 1].getBalanceDiff());
        Assert.assertEquals(-(Constants.SHUFFLING_DEPOSIT_NQT + 12 * Constants.ONE_EGL) + 100 * Constants.ONE_EGL, participants[n - 1].getUnconfirmedBalanceDiff());
