...
public class TestShuffling extends BlockchainTest {
    ...
    public void successfulShuffling() {
        ...
        Assert.assertEquals(-(defaultShufflingAmount + Constants.ONE_EGL), ALICE.getUnconfirmedBalanceDiff());
    ...
    public void verifyNotStarted() {
        ...
        Assert.assertEquals(45 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(45 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
    ...
    public void modifiedRecipientKeysDave() {
        ...
        Assert.assertEquals(75 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getBalanceDiff());
        Assert.assertEquals(75 * Constants.ONE_EGL + Constants.SHUFFLING_DEPOSIT_NQT, FORGY.getUnconfirmedBalanceDiff());
