...
public class TestApproveTransaction extends BlockchainTest {
    ...
    public void validVoteCasting() {
        ...
        APICall apiCall = new TwoPhasedMoneyTransferBuilder()
                .finishHeight(Eagle.getBlockchain().getHeight() + duration)
                .build();
        ...
        Assert.assertEquals(-50 * Constants.ONE_EGL - 2 * Constants.ONE_EGL, ALICE.getBalanceDiff());
        Assert.assertEquals(50 * Constants.ONE_EGL, BOB.getBalanceDiff());
    ...
    public void invalidVoteCasting() {
        ...
        Assert.assertEquals("ALICE balance: ", -2 * Constants.ONE_EGL, ALICE.getBalanceDiff());
    ...
    public void sendMoneyPhasedNoVoting() {
        ...
        Assert.assertEquals(-100 * Constants.ONE_EGL - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
        ...
        // Sender
        Assert.assertEquals(-100 * Constants.ONE_EGL - fee, ALICE.getBalanceDiff());
        Assert.assertEquals(-100 * Constants.ONE_EGL - fee, ALICE.getUnconfirmedBalanceDiff());
        // Recipient
