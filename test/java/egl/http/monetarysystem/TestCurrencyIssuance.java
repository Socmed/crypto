...
public class TestCurrencyIssuance extends BlockchainTest {
    ...
    public void issueMultipleCurrencies() {
        ...
        issueCurrencyApi(apiCall);
        apiCall = new Builder().naming("bXbx", "BXBX", "Currency B").feeNQT(1000 * Constants.ONE_EGL).build();
        issueCurrencyApi(apiCall);
        apiCall = new Builder().naming("ccXcc", "CCCXC", "Currency C").feeNQT(40 * Constants.ONE_EGL).build();
        issueCurrencyApi(apiCall);
    ...
    public static class Builder extends APICall.Builder {
        ...
        public Builder() {
            ...
            feeNQT(0l);
            //feeNQT(25000 * Constants.ONE_EGL);
            param("name", "Test1");
            param("code", "TSXXX");
