...
javac -encoding utf8 -sourcepath "${SP}" -classpath "${CP}" -d classes/ src/java/egl/*.java src/java/egl/*/*.java src/java/egl/*/*/*.java src/java/egldesktop/*.java || exit 1

echo "egl class files compiled successfully"
