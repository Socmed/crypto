...
/*
    EGL address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: EagleChg (admin@eglchg.com).
*/

function EagleAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('EGL-') == 0) adr = adr.substr(4);
