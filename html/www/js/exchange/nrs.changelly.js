...
var NRS = (function(NRS, $) {
    ...
    var renderExchangeTable = function (op) {
        ...
        async.series(tasks, function (err, results) {
            var table = $("#p_changelly_" + op + "_egl");
            if (err) {
    ...
    $("#changelly_buy_modal").on("show.bs.modal", function (e) {
        ...
        $("#changelly_buy_title").html($.t("exchange_egl_to_coin", { coin: to }));
        $("#changelly_buy_min").val(invoker.data("min"));
        $("#changelly_buy_min_coin").html("EGL");
        $("#changelly_buy_rate").val(invoker.data("rate"));
        $("#changelly_buy_rate_text").html("EGL/" + to);
    ...
    $("#changelly_buy_submit").on("click", function(e) {
        ...
        var amountEGL = $("#changelly_buy_amount").val();
        var minAmount = $("#changelly_buy_min").val();
        if (parseFloat(amountEGL) <= parseFloat(minAmount)) {
            var msg = "amount is lower tham minimum amount " + minAmount;
            NRS.logConsole(msg);
            NRS.showModalError(msg, $modal);
            return;
        }
        var amountNQT = NRS.convertToNQT(amountEGL);
        ...
        apiCall('generateAddress', {
            ...
            NRS.logConsole("EGL deposit address " + depositAddress);
