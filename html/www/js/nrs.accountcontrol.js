...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount EGL",
			labelI18n: "amount_egl",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumEGL",
			addonText: "EGL",
			addonI18n: "egl_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_egl', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceEGL';
		context['addonText'] = 'EGL';
		context['addonI18n'] = 'egl_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_egl', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
