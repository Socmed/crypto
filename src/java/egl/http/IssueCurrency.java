...
/**
 * Issue a currency on the EGL blockchain
 * <p>
 * A currency is the basic block of the EGL Monetary System it can be exchanged with EGL, transferred between accounts,
 ...
 * For {@link egl.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum EGL value per unit to allow the currency to become active
 * For {@link egl.CurrencyType#RESERVABLE} currency
 ...
 * For {@link egl.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link egl.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link egl.crypto.HashFunction algorithm} used for minting.
 * For {@link egl.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link egl.CurrencyType#EXCHANGEABLE} nor {@link egl.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link egl.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link egl.CurrencyType#RESERVABLE} becomes active, in case it is {@link egl.CurrencyType#CLAIMABLE} the EGL used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link egl.CurrencyType#RESERVABLE} becomes active, in case it is non {@link egl.CurrencyType#CLAIMABLE} the EGL used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link egl.CurrencyType#MINTABLE} currency, the number of units per {@link egl.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link egl.http.CurrencyMint}<br>
 * </ul>
 *
 * @see egl.CurrencyType
 * @see egl.crypto.HashFunction
 */
