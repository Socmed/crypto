...
import egl.http.EventListener.PendingEvent;
 ...
 * egl.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than egl.apiEventTimeout.</li>
 * </ul>
 *
