 ...
 * account ledger tracks all account changes as determined by the egl.ledgerAccounts,
 * egl.ledgerLogUnconfirmed and egl.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than egl.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the egl.maxAPIRecords property
 ...
 *     <tr>
 *       <td>EGL_BALANCE</td>
 *       <td>Change in the EGL balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_EGL_BALANCE</td>
 *       <td>Change in the unconfirmed EGL balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  EagleException        Invalid request
     */
    @Override
