...
import static egl.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static egl.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static egl.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static egl.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws EagleException {
        ...
        try {
            ...
            if (deliveryDeadline <= Eagle.getEpochTime()) {
