...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "EGL-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws EagleException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new EagleException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseEGL(String egl) {
        return parseStringFraction(egl, 8, Constants.MAX_BALANCE_EGL);
    }
