...
public class UPnP {
    ...
    public static synchronized void addPort(int port) {
        ...
        try {
            if (gateway.addPortMapping(port, port, localAddress.getHostAddress(), "TCP",
                                       Eagle.APPLICATION + " " + Eagle.VERSION)) {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(Eagle.getIntProperty("egl.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(Eagle.getIntProperty("egl.upnpDiscoverTimeout", discover.getTimeout()));
