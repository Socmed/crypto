...
import egl.EagleException.EagleIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  EagleIOException      Maximum count exceeded
     */
    private void incCount(long c) throws EagleIOException {
        count += c;
        if (count > limit)
            throw new EagleIOException("Maximum size exceeded: " + count);
    }
}
