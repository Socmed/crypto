...
public abstract class CurrencyExchangeOffer {
    ...
    static void exchangeCurrencyForEGL(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    static void exchangeEGLForCurrency(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    CurrencyExchangeOffer(long id, long currencyId, long accountId, long rateNQT, long limit, long supply,
        ...
        this.creationHeight = Eagle.getBlockchain().getHeight();
