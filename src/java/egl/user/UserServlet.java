...
import static egl.user.JSONResponses.DENY_ACCESS;
import static egl.user.JSONResponses.INCORRECT_REQUEST;
import static egl.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws EagleException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Eagle.getBooleanProperty("egl.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|EagleException e) {
