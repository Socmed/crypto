...
import static egl.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Eagle.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Eagle.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Eagle.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Eagle.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
