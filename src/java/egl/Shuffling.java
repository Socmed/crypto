...
public final class Shuffling {
    ...
    private static final boolean deleteFinished = Eagle.getBooleanProperty("egl.deleteFinishedShufflings");
    ...
    private void cancel(Block block) {
        ...
        if (blamedAccountId != 0) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Logger.logDebugMessage("Shuffling penalty %f EGL awarded to forger at height %d", ((double)fee) / Constants.ONE_EGL, block.getHeight() - i - 1);
            }
            ...
            Logger.logDebugMessage("Shuffling penalty %f EGL awarded to forger at height %d", ((double)fee) / Constants.ONE_EGL, block.getHeight());
        }
