...
public final class Constants {
    ...
    public static final boolean isTestnet = Eagle.getBooleanProperty("egl.isTestnet");
    public static final boolean isOffline = Eagle.getBooleanProperty("egl.isOffline");
    public static final boolean isLightClient = Eagle.getBooleanProperty("egl.isLightClient");
    public static final String customLoginWarning = Eagle.getStringProperty("egl.customLoginWarning", null, false, "UTF-8");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_EGL = 1000000000;
    public static final long ONE_EGL = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_EGL * ONE_EGL;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_EGL * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(Eagle.getIntProperty("egl.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Eagle.getIntProperty("egl.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Eagle.getIntProperty("egl.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_EGL;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Eagle.getIntProperty("egl.forgingDelay");
    public static final int FORGING_SPEEDUP = Eagle.getIntProperty("egl.forgingSpeedup");
    ...
    static {
        int maxPrunableLifetime = Eagle.getIntProperty("egl.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Eagle.getBooleanProperty("egl.includeExpiredPrunable");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_EGL;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_EGL;

    public static final boolean correctInvalidFees = Eagle.getBooleanProperty("egl.correctInvalidFees");
