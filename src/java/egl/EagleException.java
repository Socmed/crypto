...
public abstract class EagleException extends Exception {

    protected EagleException() {
        super();
    }

    protected EagleException(String message) {
        super(message);
    }

    protected EagleException(String message, Throwable cause) {
        super(message, cause);
    }

    protected EagleException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends EagleException {
    ...
    public static final class EagleIOException extends IOException {

        public EagleIOException(String message) {
            super(message);
        }

        public EagleIOException(String message, Throwable cause) {
            super(message, cause);
        }
