...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws EagleException.NotValidException;

        Transaction build(String secretPhrase) throws EagleException.NotValidException;
    ...
    void validate() throws EagleException.ValidationException;
