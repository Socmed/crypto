...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Eagle.getIntProperty("egl.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Eagle.getBlockchain().getHeight() + 720;
    ...
    private volatile EagleException.NotCurrentlyValidException failureCause;
    ...
    public EagleException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = Eagle.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(Eagle.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new EagleException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends EagleException {
