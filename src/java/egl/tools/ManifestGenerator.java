...
import egl.Eagle;
import egl.env.service.EagleService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/egl.manifest.mf", Eagle.class.getCanonicalName(), "./lib");
        String serviceClassName = EagleService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/eglservice.manifest.mf", serviceClassName, "./lib");
    }
