...
public class DesktopApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        webEngine.setUserDataDirectory(Eagle.getConfDir());
        ...
        loadWorker.stateProperty().addListener(
                (ov, oldState, newState) -> {
                    ...
                    stage.setTitle("EGL Desktop - " + webEngine.getLocation());
                    nrs = (JSObject) webEngine.executeScript("NRS");
                    updateClientState("Desktop Wallet started");
                    BlockchainProcessor blockchainProcessor = Eagle.getBlockchainProcessor();
                    ...
                    Eagle.getTransactionProcessor().addListener(transaction ->
        ...
        stage.getIcons().add(new Image(address + "/img/egl-icon-32x32.png"));
    ...
    private static String getUrl() {
        ...
        String defaultAccount = Eagle.getStringProperty("egl.defaultDesktopAccount");
